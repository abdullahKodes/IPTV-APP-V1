...
const inputs = ['components/shared/BackendApi.brs', 'components/tasks/BackendApiTask.brs', 'components/shared/PlaylistStore.brs', 'components/shared/MediaData.brs', 'components/shared/FavoriteStore.brs', 'components/shared/ProgressStore.brs', 'components/pages/SeriesDetailPage.brs'];
