...
function favoriteStoreCompactList(items as Object, playlistId as String) as Object
    ...
    for each item in items
        if item <> invalid then
            ...
            favoriteStoreCopyField(compact, item, "year")
            favoriteStoreCopyField(compact, item, "duration")
            favoriteStoreCopyField(compact, item, "genre")
            favoriteStoreCopyField(compact, item, "rating")
            favoriteStoreCopyField(compact, item, "posterUrl")
            favoriteStoreCopyField(compact, item, "cardUrl")
            ...
            favoriteStoreCopyField(compact, item, "seasonNames")
            favoriteStoreCopyField(compact, item, "episodeDurations")
            favoriteStoreCopyField(compact, item, "activeEpisodeTitle")
            favoriteStoreCopyField(compact, item, "category")
            favoriteStoreCopyField(compact, item, "groupTitle")
            favoriteStoreCopyField(compact, item, "now")
            favoriteStoreCopyField(compact, item, "programTitle")
            favoriteStoreCopyField(compact, item, "logoUrl")
            favoriteStoreCopyField(compact, item, "badgeUrl")
            favoriteStoreCopyField(compact, item, "logoText")
            favoriteStoreCopyField(compact, item, "brandColor")
            favoriteStoreCopyField(compact, item, "brandColor2")
            favoriteStoreCopyField(compact, item, "channelNumber")
            favoriteStoreCopyField(compact, item, "live")
            favoriteStoreCopyField(compact, item, "description")
            out.push(compact)
        end if
    end for
    return out
